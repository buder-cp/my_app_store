...
public class DiscoryNewView extends RelativeLayout implements MultiItemTypeAdapter.OnItemClickListener {
    ...
    private void initView() {
        ...
        CommonAdapter<RecommandFooterValue> commonAdapter = new CommonAdapter<RecommandFooterValue>(mContext,
